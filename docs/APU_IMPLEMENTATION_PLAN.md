...
3. MOBILE: notification inbox + deep links. **DONE** (inbox: `NotificationsScreen.tsx` tabs Notifications/Messages, unread dots, mark-read/mark-all; deep links deferred with the rest of the navigation work).
